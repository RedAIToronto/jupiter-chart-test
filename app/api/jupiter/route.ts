...
const ENDPOINT_CONFIG = {
  // Price API - Use public price endpoints
  'price/v2': { base: 'https://price.jup.ag/v6/', path: 'price', needsAuth: false },
  'price/v3': { base: 'https://price.jup.ag/v6/', path: 'price', needsAuth: false },
